...
function editOnPaste(e: SyntheticClipboardEvent): void {
  ...
  // IE/Edge does not support getting HTML directly from the clipboard.
  // See https://www.lucidchart.com/techblog/2014/12/02/definitive-guide-copying-pasting-javascript/
  // We can get the native paste if we do these things:
  // - Create a new (off-screen) contenteditable DOM element and redirect focus to it.
  // - Paste into contenteditable mock element
  // - Grab the HTML.
