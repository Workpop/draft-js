...
var DraftEditor = function (_React$Component) {
  ...
  DraftEditor.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: cx('DraftEditor/editorContainer'), ref: 'editorContainer' },
        React.createElement(
          'div',
          {
  ...
  DraftEditor.prototype.componentWillUnmount = function componentWillUnmount() {
    var editorNode = ReactDOM.findDOMNode(this.refs.editor);
  ...
  DraftEditor.prototype._focus = function _focus(scrollPosition) {
    ...
    var _ref2 = scrollPosition || getScrollPosition(scrollParent),
        x = _ref2.x,
        y = _ref2.y;
