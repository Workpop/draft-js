...
function editOnPaste(editor, e) {
  ...
  var clipboard = 'clipboardData' in e ? e.clipboardData : window.clipboardData;
  ...
  function handlePastedText(data, pasteText, html) {
  ...
  if (text && !html) {
    ...
    var pasteTrap = editor._pasteTrap;
    pasteTrap.focus();
    console.log(pasteTrap.innerHTML);
    setTimeout(function () {
